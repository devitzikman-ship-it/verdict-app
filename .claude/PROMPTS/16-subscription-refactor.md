...
## How to run
```bash
claude code "Read .claude/PROMPTS/16-subscription-refactor.md. This is a foundational refactor of the payment model from one-time fees to subscription + activation. Execute all phases sequentially."
```
